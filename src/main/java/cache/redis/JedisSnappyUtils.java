...
/**
 * 使用Snappy压缩方式的Redis客户端工具类
 * @author hankChan
 * @Email hankchan101@gmail.com
 * @time 21:24:43 - 13 Feb 2017
 * @detail Snappy压缩方式
 */
public class JedisSnappyUtils {

	private static final Logger LOGGER = LoggerFactory.getLogger(JedisSnappyUtils.class);
	...
	static {
		...
		try {
			props.load(JedisSnappyUtils.class.getResourceAsStream(REDIS_CONFIG_FILE));
